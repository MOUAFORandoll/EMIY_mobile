...
//       db.execute("""CREATE TABLE IF NOT EXISTS COMMANDE (
//        id INTEGER,
//        codeCommande String, 
//        codeClient String,
//        date String
...
//       db.execute("""CREATE TABLE IF NOT EXISTS KEYUSER (
//        id INTEGER,
...
//       db.execute("""CREATE TABLE IF NOT EXISTS LANG (
...
//       db.execute("""CREATE TABLE IF NOT EXISTS THEME (
...
//       db.execute("""CREATE TABLE IF NOT EXISTS  LOCALISATION (
