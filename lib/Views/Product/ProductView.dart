  ...
  Widget build(BuildContext context) {
    ...
    Object produ = Get.parameters['type'] == 'home'
        ...
        : Get.parameters['type'] == 'supplementaire'
            ? Get.find<ProductController>().produitSupplementaire[index]
    ...
    Get.find<ProductController>()
        .getListProduitSupplementaire(product.codeProduit);
    //print(product);
                        ...
                        child: prodController.conf == false
                            ? Row(mainAxisSize: MainAxisSize.max, children: [
                                IconButtonF1(
                                  icon: Icons.favorite,
                                  inconSize: 15.0,
                                  color: product.islike ? ColorsApp.red : null,
                                  backgroundColor:
                                      product.islike ? ColorsApp.white : null,
                                  padding: 9.0,
                                  onTap: () {
                                    Get.find<GeneralController>()
                                        .likeProduit(product.codeProduit, 1);
                                  },
                                ),
                                Container(
                                    width: kWidth * .80,
                                    child: AppButton(
                                      ...
                                      text: prodController.exitP(product)
                                          ? "Augmenter"
                                          : 'Ajouter',
                                      onTap: () {
