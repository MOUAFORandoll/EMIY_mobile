...
//   int idShort;
//   ShortNotificationView({required this.idShort});
...
//   void initState() {
//     super.initState();
//     Get.find<ShortController>().getUniqueShort(widget.idShort);
//   }
...
//       return WillPopScope(
//           onWillPop: () async {
//             _ShortController.isUniqueVideoPlayer!.play();
...
//                       // }
//                       if (_ShortController
//                           .isUniqueVideoPlayer!.value.isPlaying) {
//                         _ShortController.isUniqueVideoPlayer!.pause();
//                       } else {
//                         _ShortController.isUniqueVideoPlayer!.play();
//                       }
//                     });
...
//                                   .width /
//                               Get.height,
//                       child: VideoPlayer(_ShortController.isUniqueVideoPlayer!),
//                     ),
//                     Positioned(
//                       top: kHeight * .5,
//                       left: kWidth * .8,
