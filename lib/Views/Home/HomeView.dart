...
import 'package:fahkapmobile/Views/Home/SearchView.dart';
...
import 'package:fahkapmobile/components/Widget/BoutiqueComponentHome.dart';
                            ...
                            child: SingleChildScrollView(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    titleText(text: 'Boutique Populaire(s)'),
                                    Container(
                                        margin: EdgeInsets.only(
                                            top: Get.height * .005,
                                            left: Get.width * .008),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: ListView.builder(
                                ...
                                scrollDirection: Axis.horizontal,
                                itemBuilder: (_ctx, index) => CategoryComponent(
                            ...
                            categorys.ListBoutiqueF.length != 0
                                ? Container(
                                    ...
                                    child: ListView.builder(
                                        scrollDirection: Axis.horizontal,
                                        itemCount:
                                            categorys.ListBoutiqueF.length < 5
