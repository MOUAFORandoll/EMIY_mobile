...
//   ShortController _ShortController = Get.find();
//   @override
//   void initState() {
//     super.initState();
//     _ShortController.initialise
//         ? _ShortController.listShort[_ShortController.currentShort].controller!
//             .play()
//         : _ShortController.changeVideo(0);
...
//     super.dispose();
//     print('dispose');
//     if (_ShortController.listShort.isNotEmpty) {
//       if (_ShortController.listShort[_ShortController.currentShort].controller!
//           .value.isPlaying) {
//         _ShortController.listShort[_ShortController.currentShort].controller!
//             .pause();
//       }
...
//                     _ShortController.listShort[_ShortController.currentShort]
//                             .controller ==
//                         null
//                 ? AppLoading()
//                 : PageView.builder(
...
//                       _ShortController
//                           .listShort[_ShortController.currentShort].controller!
//                           .pause();
...
//     // print('*********************${_ShortController.initialise}');
//     _ShortController.initialise
//         ? _ShortController
//                                     .listShort[_ShortController.currentShort].controller!.play()
//         : _ShortController.changeVideo(0);
//     _heartAnimationController = AnimationController(
//       vsync: this,
//       duration: Duration(milliseconds: 1000),
...
//               // if (_ShortController
//                                     .listShort[_ShortController.currentShort].controller!.value.isInitialized) {
//               //   _ShortController
//                                     .listShort[_ShortController.currentShort].controller!.dispose();
//               // }
//               _ShortController.changeVideo(index);
...
//                       // }
//                       if (_ShortController
//                                     .listShort[_ShortController.currentShort].controller!.value.isPlaying) {
//                         _ShortController
//                                     .listShort[_ShortController.currentShort].controller!.pause();
//                       } else {
//                         _ShortController
//                                     .listShort[_ShortController.currentShort].controller!.play();
//                       }
